...
- **Usuario OriginAdmin**: Es el usuario creado por defecto en PiBi. La cuenta de este usuario es admin@pibi.com.ar y nos servirá para poder realizar el primer ingreso a la aplicación. Luego podremos crear un usuario con una cuenta de mail correcta y asignarle permisos de administrador. 
